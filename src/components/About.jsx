...
const SKILLS = [
  ...
  'Cleaning process design for batch and inline systems',
        ...
        <div className={styles.grid}>
          ...
          <div className={`${styles.content} reveal`}>
            ...
            <h2 className={styles.h2}>
              Passionate About<br />
              <span className={styles.red}>Technical Purity</span>
            </h2>
            ...
            <p className={styles.lead}>
              With over 15 years of hands-on experience, I help manufacturers and suppliers close the gap between design intent and production reality — ensuring every component meets the most demanding cleanliness requirements.
            </p>
